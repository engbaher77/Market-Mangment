function done_cancel_current_purchase_invoice(id){
var invoiceOrder =id;
...
var array = new Array(invoiceOrder,dateval,cash,deferred,vendor_customer_name,vendor_customer_id);
	alert (vendor_customer_name);
	
	
	if (confirm('تأكيد العمليه')) {
    // Save it!
		var xmlobj = new XMLHttpRequest();
			xmlobj.open("Get", "lib/done_cancel_current_purchase_invoice.php?q=" + JSON.stringify(array), true);
