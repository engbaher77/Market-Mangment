                        ...
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <li class="nav-item active">
                              <!--  <a href="dashboard.php" class="nav-link nav-toggle"> -->
								<a href="javascript:;" onClick="$('#requestedpage').attr({value:'dashboard'}); $('#page-form').submit();">
								<i class="fa fa-home"></i><b> فـــواتيـــرالـبيــــع </b></a>
                                  <!--  <i class="icon-home"></i>  -->
                            ...
                            <li class="nav-item">
                               <!-- <a href="Repairs.php" class="nav-link"> -->
								<a href="javascript:;" onClick="$('#requestedpage').attr({value:'repairs'}); $('#page-form').submit();">
								<i class="icon-briefcase"></i> الأصــنــــــاف</a>
                                  <!--  <i class="icon-briefcase"></i> -->
                                   <!-- <span class="title">Data Base</span> -->
                                </a>
                            </li>
